...
// in simulator we redefine to format for Objects Developer console
...
{\
	NSString * exceptionName = [@"org.objects." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.objects";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIObjectsNativeItemNone = -1, 
	UIObjectsNativeItemSpinner = -2,
	UIObjectsNativeItemProgressBar = -3,
	
	UIObjectsNativeItemSlider = -4,
	UIObjectsNativeItemSwitch = -5,
	UIObjectsNativeItemMultiButton = -6,
	UIObjectsNativeItemSegmented = -7,
	
	UIObjectsNativeItemTextView = -8,
	UIObjectsNativeItemTextField = -9,
	UIObjectsNativeItemSearchBar = -10,
	
	UIObjectsNativeItemPicker = -11,
	UIObjectsNativeItemDatePicker = -12,
	
	UIObjectsNativeItemInfoLight = -13,
	UIObjectsNativeItemInfoDark = -14,
	
	UIObjectsNativeItemDisclosure = -15,
	
	UIObjectsNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Objects instances of
