...
//@interface ObjectsObject : NSObject
//@end

@interface ObjectsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ObjectsObject class]])
		{
			for (NSString *key in [[(ObjectsObject*)o modules] allKeys])
			{
